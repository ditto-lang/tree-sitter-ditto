...
enum {
  ...
  anon_sym_LBRACK = 29,
  anon_sym_RBRACK = 30,
  sym_expression_string = 31,
  sym_expression_int = 32,
  sym_expression_float = 33,
  sym_expression_true = 34,
  sym_expression_false = 35,
  sym_expression_unit = 36,
  anon_sym_match = 37,
  anon_sym_with = 38,
  anon_sym_end = 39,
  anon_sym_PIPE_GT = 40,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [197] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat2, 2), SHIFT_REPEAT(221),
  [200] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat2, 2), SHIFT_REPEAT(315),
  [203] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat2, 2), SHIFT_REPEAT(309),
  ...
  [220] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_expression_let_repeat1, 2), SHIFT_REPEAT(129),
  [223] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_expression_let_repeat1, 2), SHIFT_REPEAT(166),
  ...
  [325] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(180),
